...
public class LayoutCashInOptionsBindingImpl extends LayoutCashInOptionsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cardCashCollection, 11);
        sViewsWithIds.put(R.id.tvCashCollection, 12);
    }
    // views
    // variables
    // values
    ...
    public LayoutCashInOptionsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private LayoutCashInOptionsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
