...
public class AppBarMainBindingImpl extends AppBarMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.main_app_bar, 1);
        sViewsWithIds.put(R.id.toolbar, 2);
        sViewsWithIds.put(R.id.tv_title, 3);
        sViewsWithIds.put(R.id.tvLedgerBalanceTitle, 4);
        sViewsWithIds.put(R.id.tvLedgerBalance, 5);
        sViewsWithIds.put(R.id.tvAvailableBalanceTitle, 6);
        sViewsWithIds.put(R.id.tvAvailableBalance, 7);
        sViewsWithIds.put(R.id.refresh_button, 8);
        sViewsWithIds.put(R.id.ivLogo, 9);
        sViewsWithIds.put(R.id.logout_layout, 10);
        sViewsWithIds.put(R.id.tvLogout, 11);
        sViewsWithIds.put(R.id.switchButton, 12);
        sViewsWithIds.put(R.id.switch_la, 13);
    }
    // views
    @NonNull
