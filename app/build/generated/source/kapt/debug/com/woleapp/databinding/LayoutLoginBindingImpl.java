...
public class LayoutLoginBindingImpl extends LayoutLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textInputUname, 6);
        sViewsWithIds.put(R.id.etEmail, 7);
        sViewsWithIds.put(R.id.textInputPwd, 8);
        sViewsWithIds.put(R.id.etPwd, 9);
        sViewsWithIds.put(R.id.txt_forgot_pwd, 10);
        sViewsWithIds.put(R.id.btn_login, 11);
        sViewsWithIds.put(R.id.tvNoAccount, 12);
        sViewsWithIds.put(R.id.tvSignUp, 13);
    }
    // views
    @NonNull
