...
import com.woleapp.databinding.LayoutWesternUnionBinding;
...
public class WesternUnionFragment extends BaseFragment implements View.OnClickListener{
    Context context;
    private LayoutWesternUnionBinding binding;
    Utilities utilities;
    AgencyUser user;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.layout_western_union, container, false);
    ...
    public void selectCountrySentFrom(){
        CountryPicker picker = CountryPicker.getInstance("Select Country", new CountryPickerListener() {
            @Override
            public void onSelectCountry(String name, String code) {
