...
import com.woleapp.model.Biller.ServiceProviderDataPlans;
import com.woleapp.model.Biller.SmileInternet;
import com.woleapp.model.Biller.SpectranetInternet;
import com.woleapp.model.Biller.BillerPlans;

import java.util.ArrayList;
import java.util.List;

import static com.woleapp.util.UtilsAndExtensionsKt.getPlansJson;
import static com.woleapp.util.UtilsAndExtensionsKt.getServiceProviderPlansJson;
...
public class DataGenerator {
    ...
    public static BillerPlans getBillerPlans(Context context) {
        String plans = getPlansJson(context);
        return new Gson().fromJson(plans, BillerPlans.class);
    }
    ...
    public static List<List<Biller.DataPlan>> getServiceProviderPlans(Context context) {
        ...
        ServiceProviderDataPlans serviceProviderDataPlans = new Gson().fromJson(dataPlans, ServiceProviderDataPlans.class);
    ...
    public static List<SmileInternet> getSmileInternetPackages(Context context) {
        String plans = getPlansJson(context);
        BillerPlans billerPlans = new Gson().fromJson(plans, BillerPlans.class);
        return billerPlans.smileInternetList;
    }

    public static List<SpectranetInternet> getSpectranetPlans(Context context) {
        String plans = getPlansJson(context);
        BillerPlans billerPlans = new Gson().fromJson(plans, BillerPlans.class);
