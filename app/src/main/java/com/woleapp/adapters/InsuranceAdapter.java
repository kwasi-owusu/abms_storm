...
public class InsuranceAdapter extends RecyclerView.Adapter<InsuranceAdapter.MyViewHolder>{
    ...
    public InsuranceAdapter(Context context, List<Service> remittanceList, OnItemClickListener.OnItemClickCallback onClick)
    {
    ...
    @Override
    public InsuranceAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
