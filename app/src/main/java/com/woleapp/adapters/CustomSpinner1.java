 ...
 */
public class CustomSpinner1 extends ArrayAdapter<Color> {
    ...
    int type = 0;
//    public CustomSpinner1(Context mContext, int layoutResourceId,
...
//    }
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            row = inflater.inflate(R.layout.spinner_view, parent, false);
...
//            else label.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
            ...
            label.setCompoundDrawableTintList(ColorStateList.valueOf(android.graphics.Color.parseColor("#ff9708")));

            Drawable mDrawable=mContext.getResources().getDrawable(R.drawable.bubble2);
            mDrawable.setColorFilter(new PorterDuffColorFilter(android.graphics.Color.parseColor("#ff9708"), PorterDuff.Mode.MULTIPLY));
